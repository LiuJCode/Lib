...
public class PtrFrameLayout extends ViewGroup {
    ...
    private boolean ismbarPullToRefresh = true;

    public void setBarPullRefresh(boolean pullRefresh) {
        ismbarPullToRefresh = pullRefresh;
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent e) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                Log.i("ismbarPullToRefresh", ismbarPullToRefresh + "____0000");
                if (ismbarPullToRefresh) {
                    Log.i("ismbarPullToRefresh", ismbarPullToRefresh + "____i");
                    mLastMoveEvent = e;

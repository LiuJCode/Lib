...
public class SwipeRecyclerView extends FrameLayout
    ...
    private boolean isHasHeader = false;// 是否有头部文件
    ...
    private void setupSwipeRecyclerView() {
        ...
        mRefreshLayout.setColorSchemeColors(getContext().getResources().getColor(R.color.white));
        ...
        recyclerView.setOnScrollListener(new OnScrollListener() {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                // 每一页显示10条数据
                if (childCount > 9 && lastVisiablePosition == childCount - 1) {
...
//            }
     ...
     *
     * @author LIUJING
     * @created at 2016/12/22 16:36
     */
    public void onFootViewClick(View view, final Context context) {
        if (mFootView != null) {
            mFootView.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View view) {
                    LogFactory.createLog("lib").e("点击底部");
                }
            });
        }
    }
    ...
    private class WrapperAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public static final int TYPE_HEADER = 0x200;
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            if (TYPE_HEADER == viewType && headview != null) {
